...
%>
    ...
    <form action="otp3.jsp" method="post">
    <center>

    <tr><td><font color="black"> OTP :</td><td><input type="text" name="otp" required="" /></td></tr>
  
    <tr><td><font color="black"> New Password :</td><td><input type="text" name="password" required="" /></td></tr>
