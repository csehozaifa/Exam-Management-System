...
<body>
    ...
    <div class="news">
    <br/><br/>
    <center><p><font size="5" color="black">Faculty Login </font></p><br/></center>
     
    <form action="facultyact.jsp" method="post">
    ...
    <tr rowspan="2" align="center"><td><br><input type="submit" name="submit" value="Login" /></td>
        <td><br><a href="forgot.jsp">forgot Password</a></td></tr>
